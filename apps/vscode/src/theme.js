...
function getTheme({ style, name }) {
    ...
    return {
        ...
        tokenColors: [
            ...
            {
                scope: ["meta.decorator", "entity.name.decorator", "storage.modifier.attribute.swift"],
                settings: {
            ...
            {
                scope: "keyword.operator.function-result.swift",
                settings: {
                    foreground: tokens.syntax.keyword,
                    fontStyle: "regular",
                },
            },
            {
                scope: [
                    ...
                    "keyword.other.operator.type.opaque.swift"
                ],
                settings: {
                    fontStyle: "italic",
                },
